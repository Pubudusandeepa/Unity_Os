;UNITY --- The UNITY Operating System Kernel
;===================================================================

	BITS 16
	%DEFINE UNITY_VER '1.0.0'	 ;OS version number
	%DEFINE UNITY_API_VER 1	; API version for programs to check
	%DEFINE KEY_ESC		27
...
os_main:
	...
	mov es, ax			; segments ever again, as UNITY and its programs
...
option_screen:
	...
	os_init_msg		db '--------------------------Welcome to UNITY----------------------------', 0
	os_version_msg		db 'Version ', UNITY_VER, 0

	os_init_msg2		db '                         Hardware Information                               ', 0
	os_version_msg2		db 'Version ', UNITY_VER, 0

	dialog_string_1		db 'Welcome to UNITY Operating System', 0
	dialog_string_2		db 'Please select SHHD for HardwareInfo or', 0
...
os_draw_background1:
	...
	mov cx, 00000010b		; Colour: white text on light blue
